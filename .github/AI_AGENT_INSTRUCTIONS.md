...
1. ✅ Read the current phase in `/Docs/ROADMAP.md`
2. ✅ Review related documentation in `/Docs/` directory
3. ✅ Check existing code structure and patterns
4. ✅ Verify prerequisites are met for the task
5. ✅ Ask clarifying questions if requirements are ambiguous

### During Development
1. ✅ Follow the task breakdown in the roadmap
2. ✅ Write tests alongside code (TDD approach when feasible)
3. ✅ Keep commits focused and atomic (but wait for user approval to commit)
4. ✅ Update documentation as features are implemented
5. ✅ Run existing tests to ensure no regressions
6. ✅ Perform basic manual testing of new functionality

### After Completing a Task
1. ✅ Mark the task as complete in the roadmap: `- [x] Task description`
2. ✅ Run all tests and verify they pass
3. ✅ Update relevant documentation
4. ✅ Provide a summary of changes to the user
5. ✅ **WAIT for user validation** before committing or proceeding
6. ✅ Address any issues found during manual testing

### Commit Process
1. ✅ User performs manual verification
2. ✅ User approves the changes
3. ✅ Suggest commit message following conventional commits format
4. ✅ Wait for user to execute the commit command
5. ✅ Proceed to next task only after commit is made
...
│   ├── ROADMAP.md       # PRIMARY REFERENCE - Project roadmap
│   ├── ARCHITECTURE.md   # Technical architecture
│   └── ...
├── src/                  # Source code (all code goes here)
│   ├── backend/         # C# pattern matching engine
│   └── extension/       # VS Code extension (TypeScript)
├── tests/               # Test projects
├── .gitignore          # Generated by dotnet CLI
├── .editorconfig       # Generated by dotnet CLI
├── .gitattributes      # Generated by dotnet CLI
├── LICENSE             # MIT License
...
```
✅ Completed: [Task Name from Roadmap]
...
**Remember:**
1. 📖 Follow the roadmap (but adapt as needed)
2. ✋ Wait for user validation before committing
3. 🤝 Collaborate on technical decisions
4. ✅ Complete tasks thoroughly with tests
